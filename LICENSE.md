...
3. The source code is private and remains the property of the developer (MIIIME).
4. Reverse engineering or unauthorized modification is prohibited.
...
3. 소스 코드는 비공개이며, 모든 권리는 제작자(MIIIME)에게 있습니다.
4. 역설계(리버스 엔지니어링) 또는 허가되지 않은 수정은 금지됩니다.
5. 소프트웨어는 "있는 그대로" 제공되며, 사용 중 발생하는 문제에 대해 제작자는 책임을 지지 않습니다.
